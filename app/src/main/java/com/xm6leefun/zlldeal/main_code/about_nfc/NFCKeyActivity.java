...
//商户入驻
public class NFCKeyActivity extends MyBaseActivity {

    private static NfcAdapter mAdapter;

    byte[] keys = hexString2Byte("123456");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nfc_key);
...
//            mAdapter.enableForegroundDispatch(this, mPendingIntent, mIntentFilters, mTechList);
    ...
    public void readTag() {
        String str = "...";
//              Intent  intent = (Intent)getIntent().getParcelableExtra(NfcAdapter.ACTION_NDEF_DISCOVERED);
        try {
            if (intent!=null)
...
//        }
   ...
   public static class nfcStatusDialog extends DialogFragment {
        @Override
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
